...
def runExperiment2(mysql_cnx, cassandra, iterations=1):
    ...
    mysql_queries = get_queries("experiments/experiment2/experiment2.sql")
    cassandra_queries = get_queries("experiments/experiment2/experiment2.cql")
